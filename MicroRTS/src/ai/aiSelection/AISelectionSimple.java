 ...
 * @author rubens
 */
public class AISelectionSimple extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public AISelectionSimple(UnitTypeTable utt) {
        this(100, -1, 100, 1, 1,
                new EvalSelection(),
    ...
    public AISelectionSimple(UnitTypeTable utt, ArrayList<Integer> iScripts) {
        this(100, -1, 100, 1, 1,
                new EvalSelection(),
                utt,
                new AStarPathFinding(),
    ...
    public AISelectionSimple(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    public AISelectionSimple(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e,
    ...
    protected void buildPortfolio(ArrayList<Integer> iScripts) {
        ...
        this.scriptsMin.add(scriptsCompleteSet.get(0));
        this.scriptsMin.add(scriptsCompleteSet.get(1));
        this.scriptsMin.add(scriptsCompleteSet.get(2));
        this.scriptsMin.add(scriptsCompleteSet.get(3));
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        System.out.println("lastBestMoveValue " + ab.getBestMoveValue());
    ...
    * Executa um playout de tamanho igual ao @LOOKAHEAD e retorna o valor
    ...
    @Override
    public AI clone() {
        return new AISelectionSimple(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }

 ...
 */
public class IDABCDAsymmetric extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDABCDAsymmetric(UnitTypeTable utt) {
        this(100, -1,
                new POWorkerRush(utt, new AStarPathFinding()), 100,
                new SimpleSqrtEvaluationFunction3(), true);
    }

    public IDABCDAsymmetric(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCDAsymmetric(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }

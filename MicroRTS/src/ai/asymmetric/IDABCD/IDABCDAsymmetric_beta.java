 ...
 */
public class IDABCDAsymmetric_beta extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDABCDAsymmetric_beta(UnitTypeTable utt) {
        this(100, -1,
                new WorkerRush(utt, new AStarPathFinding()), 100,
                new SimpleSqrtEvaluationFunction3(), true);
    }

    public IDABCDAsymmetric_beta(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCDAsymmetric_beta(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }

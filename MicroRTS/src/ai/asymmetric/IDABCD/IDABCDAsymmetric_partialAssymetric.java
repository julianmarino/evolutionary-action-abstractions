 ...
 */
public class IDABCDAsymmetric_partialAssymetric extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public IDABCDAsymmetric_partialAssymetric(UnitTypeTable utt) {
        this(100, -1,
                new WorkerRush(utt, new AStarPathFinding()), 100,
                new SimpleSqrtEvaluationFunction3(), true);
    }

    public IDABCDAsymmetric_partialAssymetric(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCDAsymmetric_partialAssymetric(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }
